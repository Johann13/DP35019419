...
public class ShopProductTable 
{

   public ShopProductTable(ShopProduct... start)
   {
      this.setColumnName("ShopProduct");
      columnMap.put(this.getColumnName(), 0);
      for (ShopProduct current : start)
      {
   ...
   public ShopProductTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public ShopProductTable setColumnName(String value)
   {
   ...
   public ShopProductTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandName(String... rowName)
   {
      ...
      {
         ShopProduct start = (ShopProduct) row.get(columnMap.get(this.getColumnName()));
   ...
   public doubleTable expandInStock(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         ShopProduct start = (ShopProduct) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getInStock());
         this.table.add(newRow);
      }
      return result;
   }

   public doubleTable expandPrice(String... rowName)
   {
      doubleTable result = new doubleTable();
      result.setColumnMap(this.columnMap);
      result.setTable(this.table);
   ...
   public ShopProductTable hasShop(ShopTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopOrderTable expandOrders(String... rowName)
   {
      ShopOrderTable result = new ShopOrderTable();
      result.setColumnMap(this.columnMap);
      result.setTable(table);
      int newColumnNumber = this.table.size() > 0 ? this.table.get(0).size() : 0;
      ...
      {
         ShopProduct start = (ShopProduct) row.get(columnMap.get(this.getColumnName()));
         for (ShopOrder current : start.getOrders())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public ShopProductTable hasOrders(ShopOrderTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ShopProduct start = (ShopProduct) row.get(columnMap.get(this.getColumnName()));
         ShopOrder other = (ShopOrder) row.get(columnMap.get(rowName.getColumnName()));
   ...
   public ShopProductTable selectColumns(String... columnNames)
   {
   ...
   public ShopProductTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public ShopProductTable filter(Predicate< ShopProduct > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopProductTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< ShopProduct > toSet()
   {
      LinkedHashSet< ShopProduct > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         ShopProduct value = (ShopProduct) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
