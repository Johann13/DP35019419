...
public class ShopTable 
{
   ...
   public ShopTable(Shop... start)
   {
      this.setColumnName("Shop");
      columnMap.put(this.getColumnName(), 0);
      for (Shop current : start)
      {
   ...
   public ShopTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public ShopTable setColumnName(String value)
   {
   ...
   public ShopTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public ShopCustomerTable expandCustomers(String... rowName)
   {
      ...
      {
         Shop start = (Shop) row.get(columnMap.get(this.getColumnName()));
         for (ShopCustomer current : start.getCustomers())
         {
   ...
   public ShopTable hasCustomers(ShopCustomerTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getCustomers().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public ShopProductTable expandProducts(String... rowName)
   {
      ...
      {
         Shop start = (Shop) row.get(columnMap.get(this.getColumnName()));
         for (ShopProduct current : start.getProducts())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public ShopTable hasProducts(ShopProductTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopTable hasOrders(ShopOrderTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopTable selectColumns(String... columnNames)
   {
   ...
   public ShopTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public ShopTable filter(Predicate< Shop > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Shop > toSet()
   {
      LinkedHashSet< Shop > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Shop value = (Shop) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
