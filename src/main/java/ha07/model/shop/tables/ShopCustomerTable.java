...
public class ShopCustomerTable 
{

   public ShopCustomerTable(ShopCustomer... start)
   {
      this.setColumnName("ShopCustomer");
      columnMap.put(this.getColumnName(), 0);
      for (ShopCustomer current : start)
      {
   ...
   public ShopCustomerTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public ShopCustomerTable setColumnName(String value)
   {
   ...
   public ShopCustomerTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandAddress(String... rowName)
   {
      ...
      {
         ShopCustomer start = (ShopCustomer) row.get(columnMap.get(this.getColumnName()));
   ...
   public ShopCustomerTable hasShop(ShopTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopCustomerTable hasOrders(ShopOrderTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopCustomerTable selectColumns(String... columnNames)
   {
   ...
   public ShopCustomerTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public ShopCustomerTable filter(Predicate< ShopCustomer > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShopCustomerTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< ShopCustomer > toSet()
   {
      LinkedHashSet< ShopCustomer > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         ShopCustomer value = (ShopCustomer) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
