...
public class WarehouseProductTable 
{

   public WarehouseProductTable(WarehouseProduct... start)
   {
      this.setColumnName("WarehouseProduct");
      columnMap.put(this.getColumnName(), 0);
      for (WarehouseProduct current : start)
      {
   ...
   public WarehouseProductTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public WarehouseProductTable setColumnName(String value)
   {
   ...
   public WarehouseProductTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandName(String... rowName)
   {
      ...
      {
         WarehouseProduct start = (WarehouseProduct) row.get(columnMap.get(this.getColumnName()));
   ...
   public WarehouseProductTable hasWarehouse(WarehouseTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LotTable expandLots(String... rowName)
   {
   ...
   public WarehouseProductTable hasLots(LotTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getLots().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public WarehouseProductTable hasOrders(WarehouseOrderTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public WarehouseProductTable selectColumns(String... columnNames)
   {
   ...
   public WarehouseProductTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public WarehouseProductTable filter(Predicate< WarehouseProduct > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public WarehouseProductTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< WarehouseProduct > toSet()
   {
      LinkedHashSet< WarehouseProduct > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         WarehouseProduct value = (WarehouseProduct) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
