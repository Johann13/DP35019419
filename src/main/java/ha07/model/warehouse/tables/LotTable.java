...
public class LotTable 
{
   ...
   public LotTable(Lot... start)
   {
      this.setColumnName("Lot");
      columnMap.put(this.getColumnName(), 0);
      for (Lot current : start)
      {
   ...
   public LotTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public LotTable setColumnName(String value)
   {
   ...
   public LotTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandId(String... rowName)
   {
      ...
      {
         Lot start = (Lot) row.get(columnMap.get(this.getColumnName()));
   ...
   public doubleTable expandLotSize(String... rowName)
   {
   ...
   public LotTable hasWarehouseProduct(WarehouseProductTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LotTable hasPlaces(PalettePlaceTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LotTable selectColumns(String... columnNames)
   {
   ...
   public LotTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public LotTable filter(Predicate< Lot > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LotTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Lot > toSet()
   {
      LinkedHashSet< Lot > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Lot value = (Lot) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
